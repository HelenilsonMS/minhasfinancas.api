...
import com.hms.minhasfinancas.api.DTO.AtualizaStatusDTO;
import com.hms.minhasfinancas.api.DTO.LancamentoDTO;
...
public class LancamentoController {
	...
	public ResponseEntity salvar(@RequestBody LancamentoDTO dto) {
		try {
			...
			entidade = service.savar(entidade);
	...
	public ResponseEntity buscar(@RequestParam(value = "descricao", required = false) String descricao,
		...
		Optional<Usuario> usuario = usuarioService.obtUsuario(idUsuario);
	...
	private Lancamento converter(LancamentoDTO dto) {
		...
		Usuario usuario = usuarioService.obtUsuario(dto.getUsuario())
